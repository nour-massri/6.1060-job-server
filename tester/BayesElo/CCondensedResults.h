...
class CCondensedResult {  // cr
 public:
  ...
  void Reset();
  float Games() const {
    return w_ij + d_ij + l_ij + w_ji + d_ji + l_ji;
  }
  float Score() const {
    return w_ij + l_ji + (d_ij + d_ji) * 0.5;
  }
};
...
class CCondensedResults {  // crs
 ...
 public:  ////////////////////////////////////////////////////////////////////
  ...
  int GetOpponents(int Player) const {
    return pOpponents[Player];
  }
...
#endif  // CCondensedResults_Declared
