...
class CMove {  // move
 ...
 public:  ///////////////////////////////////////////////////////////////////
  ...
  // Basic sets and gets
  //
  void SetFrom(unsigned char sq) {
    sqFrom = sq;
  }
  void SetTo(unsigned char sq) {
    sqTo = sq;
  }
  void SetType(unsigned char uc) {
    ucType = uc;
  }
  void SetSAN(unsigned char uc) {
    ucSAN = uc;
  }
  void AddSAN(unsigned char uc) {
    ucSAN |= uc;
  }
