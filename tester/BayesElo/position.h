...
class CPosition {  // pos
 ...
 public:  ///////////////////////////////////////////////////////////////////
  ...
  int GetBlackOO() const {
    return fBlackOO;
  }
  int GetWhiteOO() const {
    return fWhiteOO;
  }
  int GetBlackOOO() const {
    return fBlackOOO;
  }
  int GetWhiteOOO() const {
    return fWhiteOOO;
  }
  int GetEnPassant() const {
    return sqEnPassant;
  }
  int GetReversible() const {
    return nhmReversible;
  }
  int GetMoves() const {
    return nm;
  }
  ...
  void SetPlayer(int playerNew) {
    player = playerNew;
  }
  void SetBlackOO(int f) {
    fBlackOO = f;
  }
  void SetWhiteOO(int f) {
    fWhiteOO = f;
  }
  void SetBlackOOO(int f) {
    fBlackOOO = f;
  }
  void SetWhiteOOO(int f) {
    fWhiteOOO = f;
  }
  void SetEnPassant(int sq) {
    sqEnPassant = sq;
  }
  void SetReversible(int nhm) {
    nhmReversible = nhm;
  }
  void SetMoves(int nmNew) {
    nm = nmNew;
  }
  ...
  //
  static const CHashCodeComputer& GetHashCodeComputer() {
    return hcc;
  }
};
